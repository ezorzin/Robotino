...
x_min = -0.1;                                                   // Setting "x_min"...
x_max = +0.1;                                                   // Setting "x_max"...
y_min = -0.05;                                                  // Setting "y_min"...
y_max = +0.05;                                                  // Setting "y_max"...
z_min = -0.02;                                                  // Setting "z_min"...
z_max = +0.02;                                                  // Setting "z_max"...
...
z_side = 9;                                                     // Setting "z-side" tag (physical group)...
...
Physical Curve(x_side) = {-CD};                                  // Setting group: side "AB"...
Physical Curve(y_side) = {DH};                                  // Setting group: side "AD"...
Physical Curve(z_side) = {DA};                                  // Setting group: side "AD"...
