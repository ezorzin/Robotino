...
int main ()
{
  ...
  while(!gl->closed ())                                                                              // Opening window...
  {
    ...
    if(hud->button ("(U)pdate", 100) || gl->key_U)
    {
      ...
      dt_critical         = sqrt (m/K);                                                              // Critical time step [s].
      dt_simulation       = 0.5f*dt_critical;                                                        // Simulation time step [s].
      body_param->data[0] = g;                                                                       // Setting gravity...
      body_param->data[1] = m;                                                                       // Setting mass...
      body_param->data[2] = K;                                                                       // Setting stiffness...
      body_param->data[3] = B;                                                                       // Setting damping...
      body_param->data[4] = dt_simulation;                                                           // Setting simulation time step...
